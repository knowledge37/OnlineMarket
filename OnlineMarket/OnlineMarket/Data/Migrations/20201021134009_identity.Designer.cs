...
{
    [DbContext(typeof(NkTechSolutionContext))]
    [Migration("20201021134009_identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DutchTreat.Data.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            OrderDate = new DateTime(2020, 10, 21, 13, 40, 9, 1, DateTimeKind.Utc).AddTicks(4299),
                            OrderNumber = "12345"
                        });
                });
            ...
            modelBuilder.Entity("OnlineMarket.Data.Entities.StoreUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("DutchTreat.Data.Entities.Order", b =>
                {
                    b.HasOne("OnlineMarket.Data.Entities.StoreUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("OnlineMarket.Data.Entities.StoreUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
